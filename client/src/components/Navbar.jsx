  ...
  const Navbar = () => {
    ...
    return (
      <header className="sticky top-5 inset-x-0 mx-auto w-[calc(100%-2rem)] max-w-7xl rounded-3xl z-50 bg-white/90 backdrop-blur-md border border-slate-200/80 shadow-md transition-all duration-300">
            ...
            <div className="flex-1 hidden md:flex items-center justify-end gap-4">
              {isAuthenticated ? (
                ...
                <div className="flex items-center gap-4 -translate-x-4">
                  ...
                  <Link
                    to="/register"
                    className="px-6 py-2.5 bg-[#0088cc] hover:bg-[#4f93be] text-white text-sm font-extrabold rounded-full shadow-md shadow-sky-600/20 transition-all transform hover:scale-[1.02]"
                  >
                    Register
                  </Link>
                </div>
